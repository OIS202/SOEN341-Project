...
<?php
    echo getcwd();
    $products = fopen("C:/xampp/htdocs/edit-product/myProducts.csv", "r");
    ...
    while (($row = fgetcsv($products)) !== false) {
        ...
        echo "<td><a href='../edit-product/edit-product.php?id=$productid'><button type='button' class='btn btn-primary btn-sm' style='margin-right: 4px;'>asdf</button></a>
        <a href='../edit-product/delete-product.php?name=$productName'><button onclick='' type='submit' class='btn btn-danger btn-sm'>Remove</button></a></td>";
        echo "</tr>\n";
    }
    fclose($products);
    echo "\n</table>";
